  ...
  return (
    <Flex direction="column" gap="4">
        ...
        <Flex justify="between" align="start" gap="4" wrap="wrap">
          <Box>
            <Flex align="center" gap="2">
              ...
              <Badge color={STATUS_COLORS[app.status as keyof typeof STATUS_COLORS] ?? "gray"}>
      ...
      <Tabs.Root defaultValue="details">
        <Tabs.List>
          <Tabs.Trigger value="details">{t("applicationDetail.tabs.details")}</Tabs.Trigger>
          <Tabs.Trigger value="activity">{t("applicationDetail.tabs.activity")}</Tabs.Trigger>
        ...
        <Box pt="4">
          ...
          <Tabs.Content value="attachments">
            <AttachmentList applicationId={app.id} attachments={app.attachments} />
          </Tabs.Content>
        </Box>
      </Tabs.Root>
    </Flex>
