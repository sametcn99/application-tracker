...
import { Button, Card, Flex, TextArea, Callout, Text } from "@radix-ui/themes";
      ...
      <form id="add-activity-form" action={onSubmit}>
        <Flex direction="column" gap="3">
          <Text size="2" weight="medium">
            {t("addNoteTitle", { defaultMessage: "Add a Note (Markdown supported)" })}
          </Text>
          <TextArea
            name="comment"
            placeholder={t("addPlaceholder", { defaultMessage: "Write a note..." })}
            rows={3}
            disabled={pending}
            style={{
          ...
          <Flex justify="end">
            <Button type="submit" disabled={pending} size="2">
              {pending ? t("submitting", { defaultMessage: "Submitting..." }) : t("addButton", { defaultMessage: "Add Note" })}
            </Button>
          </Flex>
        </Flex>
      </form>
